...
/// <summary>Contains extension methods for the maybe class.</summary>
public static class MaybeExtensions
{
    ...
    /// <returns>The success result with the bound value if the maybe has a value, otherwise None.</returns>
    ...
    /// <summary>Matches to the corresponding functions based on existence of the value.</summary>
    ...
    /// <returns>The result of the on-success function if the maybe has a value, otherwise the result of the onFailure function.</returns>
